...
describe "crowdfunder sql" do
  ...
  describe "questions" do
    ...
    xit '#selects_the_titles_of_all_projects_and_their_pledge_amounts' do
    ...
    xit '#selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal' do
    ...
    xit '#selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_amount' do
    ...
    xit '#selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_book_category' do
